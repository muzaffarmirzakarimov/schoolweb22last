...
import com.example.schoolweb22.dto.AdminFrontDto;
...
import com.example.schoolweb22.repository.AuthTokenRepository;
...
//        Admin admin = adminRepository.findByPhoneNumberAndActiveTrue(phoneNumber);
//        if(admin!=null && checkPassword(admin.getPassword(), password)){
//            return admin;
//        }
//        return null;
//    }
    public AdminFrontDto getAdmin(HttpServletRequest req){
        ...
        Admin admin = byId.get().getAdmin();
        return new AdminFrontDto(admin.getFirstName(), admin.getLastName(), admin.getPhoneNumber(), admin.getId());
    }
